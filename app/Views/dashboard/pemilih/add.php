        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="<?= base_url() ?>/dashboard/pemilih/add" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" inputmode="email" autocomplete="email" placeholder="<?= lang('Auth.email') ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="username" name="username" inputmode="text" autocomplete="username" readonly placeholder="Token">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" inputmode="text" autocomplete="first_name" placeholder="<?= lang('Auth.first_name') ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="last_name" class="form-label"><?= lang('Auth.last_name') ?>*</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" inputmode="text" autocomplete="last_name" placeholder="<?= lang('Auth.last_name') ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 mb-2">
                                                <img src="<?= base_url(); ?>/uploads/image_user/DEFAULT-L.png" id="image-user-show" class="img-fluid img-thumbnail rounded" />
                                            </div>
                                            <div class="col-sm-8">
...
<script src="<?= base_url(); ?>/assets/js/pages/pemilih-add.init.js"></script>
<?= $this->endSection() ?>