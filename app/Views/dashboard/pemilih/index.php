        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Data Pemilih</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">Data Pemilih <?= $appIdentity['app_title']; ?></h5>
                        <div class="flex-shrink-0">
                            <a href="<?= base_url(); ?>/dashboard/pemilih/add" class="btn btn-sm btn-primary"><i class="ri-file-add-line fs-14 align-middle"></i> Tambah Pemilih</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="tb-data-pemilih" class="table table-bordered nowrap table-striped align-middle">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Nama</th>
...
<script src="<?= base_url(); ?>/assets/js/pages/pemilih.init.js"></script>
<?= $this->endSection() ?>