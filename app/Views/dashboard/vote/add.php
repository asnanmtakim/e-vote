        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="<?= base_url() ?>/dashboard/calon/add" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label for="nama_calon" class="form-label">Nama Calon*</label>
                                        <input type="text" class="form-control" id="nama_calon" name="nama_calon" inputmode="text" autocomplete="nama_calon" placeholder="Nama Calon">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div id="gender-form">
                                            <div class="form-check form-check-inline form-radio-success">
                                                <input class="form-check-input" type="radio" name="gender_calon" id="genderL" value="L">
                                                <label class="form-check-label" for="genderL">Laki-laki</label>
                                            </div>
                                            <div class="form-check form-check-inline form-radio-success">
                                                <input class="form-check-input" type="radio" name="gender_calon" id="genderP" value="P">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 mb-2">
                                                <img src="<?= base_url(); ?>/uploads/foto_calon/DEFAULT-L.png" id="image-user-show" class="img-fluid img-thumbnail rounded" />
                                            </div>
                                            <div class="col-sm-8">
                                                <input type="file" accept="image/*" name="foto_calon" class="form-control image-user-input" id="foto_calon" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="<?= base_url(); ?>/assets/js/pages/calon-add.init.js"></script>
<?= $this->endSection() ?>