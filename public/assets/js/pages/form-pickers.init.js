   ...
   opacityHueColorPickr =
      (demoColorPickr &&
         Array.from(demoColorPickr).forEach(function () {
            Pickr.create({ el: ".colorpicker-demo", theme: "monolith", default: "#405189", components: { preview: !0, interaction: { clear: !0, save: !0 } } });
         }),
      document.querySelectorAll(".colorpicker-opacity-hue")),
   swatcherColorPickr =
      (opacityHueColorPickr &&
         Array.from(opacityHueColorPickr).forEach(function () {
            Pickr.create({ el: ".colorpicker-opacity-hue", theme: "monolith", default: "#0ab39c", components: { preview: !0, opacity: !0, hue: !0, interaction: { clear: !0, save: !0 } } });
         }),
